...
namespace MovieArchive.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //Farklı register sayfası oluşturup burada bir admin bir de uye nesnesi oluşturmayı dene
                var user = new Uye()
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    //User Role burada setleniyor!!!!Bura client' dı ben uye olarak değiştirdim.
