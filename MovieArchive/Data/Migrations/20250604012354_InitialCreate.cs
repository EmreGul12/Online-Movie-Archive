        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YayinTarihi = table.Column<int>(type: "int", nullable: false),
                    Yoneten = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ToplamPuanVerenKisi = table.Column<long>(type: "bigint", nullable: false),
                    ToplamPuan = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Filmler_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Puanlar_Filmler_FilmId",
                        column: x => x.FilmId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3f29a0c2-1d5f-4e3b-8a1b-2dbb4b503e4d", "d1c5a6f2-8e0a-4c15-b8c7-5fa2c8e798ab", "Admin", "ADMIN" },
                    { "a7d55a5d-7c77-4ae4-b4f3-6db3462e5f12", "f7b2f3a0-4c18-46e0-9c2f-90bb0f4e1a7c", "Uye", "UYE" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Filmler_AdminId",
                table: "Filmler",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Puanlar_FilmId",
                table: "Puanlar",
                column: "FilmId");
